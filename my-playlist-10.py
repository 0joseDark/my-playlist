...
import vlc
import yt_dlp  # Importa o yt-dlp para decodificar URLs do YouTube
...
# Função para obter a URL decodificada de um vídeo do YouTube
def obter_url_decodificada(url):
    ...
    def reproduzir_stream_selecionada(self):
        ...
        if item:
            ...
            if "youtube.com" in url or "youtu.be" in url:
                url = obter_url_decodificada(url)  # Decodifica URL do YouTube
