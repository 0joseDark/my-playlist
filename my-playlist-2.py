...
class MyApp:
    def __init__(self, root):
        ...
        # Botão para abrir o navegador embutido
        browser_btn = tk.Button(self.root, text="Abrir YouTube", command=self.abrir_navegador)
    ...
    def abrir_url_e_tocar(self):
        ...
        url = tk.simpledialog.askstring("Abrir URL", "Digite o URL do YouTube:")
        if url:
            self.url = url
    ...
    def abrir_navegador(self):
        # Abre um navegador embutido com CEF para acessar o YouTube
        cef.Initialize()
...
if __name__ == "__main__":
    ...
    sys.excepthook = cef.ExceptHook  # Para capturar exceções CEF
    root = tk.Tk()
    app = MyApp(root)
    root.mainloop()
    cef.Shutdown()
